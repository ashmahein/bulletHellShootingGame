    ...
    class Grunt1Creator : EntityCreator
    {
        ...
        public override Entity GetEntity(string move, string shoot, int startX, int startY, int endX, int endY, String bTexture, String eTexture)
        {
            ...
            if (move == "MoveLikeFinal")
            {
                ...
                {
                    return new Grunt1(startPos, endPos, health, speedMode, sprite, bulletTexture, content, new MoveLikeFinal(), new ShootLikeFinal());
                }
                else if (shoot == "ShootLikeGrunt")
                {
                    return new Grunt1(startPos, endPos, health, speedMode, sprite, bulletTexture, content, new MoveLikeFinal(), new ShootLikeGrunt());
                }
                else if (shoot == "ShootLikeMid")
                {
                    return new Grunt1(startPos, endPos, health, speedMode, sprite, bulletTexture, content, new MoveLikeFinal(), new ShootLikeMid());
                }
                else if (shoot == "ShootLikePlayer")
                {
                    return new Grunt1(startPos, endPos, health, speedMode, sprite, bulletTexture, content, new MoveLikeFinal(), new ShootLikePlayer(this.content));
                }
                else
                {
            ...
            else if (move == "MoveLikeGrunt1")
            {
                if (shoot == "ShootLikeFinal")
                {
                    return new Grunt1(startPos, endPos, health, speedMode, sprite, bulletTexture, content, new MoveLikeGrunt1(), new ShootLikeFinal());
                }
                else if (shoot == "ShootLikeGrunt")
                {
                ...
                {
                    return new Grunt1(startPos, endPos, health, speedMode, sprite, bulletTexture, content, new MoveLikeGrunt1(), new ShootLikeMid());
                }
                else if (shoot == "ShootLikePlayer")
                {
                    return new Grunt1(startPos, endPos, health, speedMode, sprite, bulletTexture, content, new MoveLikeGrunt1(), new ShootLikePlayer(this.content));
                }
                else
                {
                    return new Grunt1(startPos, endPos, health, speedMode, sprite, bulletTexture, content, new MoveLikeGrunt1(), new ShootLikePlayer(this.content));
            ...
            else if (move == "MoveLikeMid")
            {
                if (shoot == "ShootLikeFinal")
                {
                    return new Grunt1(startPos, endPos, health, speedMode, sprite, bulletTexture, content, new MoveLikeMid(), new ShootLikeFinal());
                }
                else if (shoot == "ShootLikeGrunt")
                {
                    return new Grunt1(startPos, endPos, health, speedMode, sprite, bulletTexture, content, new MoveLikeMid(), new ShootLikeGrunt());
                }
                else if (shoot == "ShootLikeMid")
                {
                    return new Grunt1(startPos, endPos, health, speedMode, sprite, bulletTexture, content, new MoveLikeMid(), new ShootLikeMid());
                }
                else if (shoot == "ShootLikePlayer")
                {
